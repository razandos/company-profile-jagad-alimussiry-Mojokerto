...
<head>
  ...
  <title>BERITA - Raj Hikmatul Karomah</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
            @foreach ($event as $berita1 )
              <div class="entry-img">
                <img src="image/{{$berita1->image}}" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-meta">
                <ul>
                    <li class="d-flex align-items-center">
                        ...
                        <a href="">{{ $berita1->user->name }}  </a>
                        <span style="margin-left: 2vh;">{{ $berita1->event_date }}</span>
                    </li>
                </ul>
              </div>
