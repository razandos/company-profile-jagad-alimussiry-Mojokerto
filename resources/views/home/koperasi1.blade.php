...
<head>
  ...
  <title>KOPERASI - Raj Hikmatul Karomah</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Unit Lembaga</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="koperasi" class="active">Koperasi</a></li>
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-8 entries">
            @foreach ($koperasi as $koperasi1 )
            <article class="entry">

              <div class="entry-img">
                <img src="image/{{$koperasi1->image}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="">{{$koperasi1->title}}</a>
              </h2>

              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="">{{ $koperasi1->user->name }}</a></li>
                </ul>
              </div>
              <!-- koperasi1 adalah acara spiritual yang diadakan secara massal dengan tujuan untuk memperkuat ikatan batin dengan Allah SWT dan meningkatkan kedamaian spiritual. Acara ini dihadiri oleh jamaah yang berasal dari berbagai daerah, yang berkumpul dalam kebersamaan untuk beribadah, berdoa, dan mengungkapkan rasa syukur kepada Sang Pencipta.
              -->
              <div class="entry-content">
              <p id="content">
              {{$koperasi1->description}}
             </p>
            
              <p id="additional-content" style="display: none;">
              {{$koperasi1->description}}
              <br>
              {{$koperasi1->descriptionlengkap}}
               </p>
