...
<head>
  ...
  <title>RUANG MEDIA GURU- Raj Hikmatul Karomah</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Unit Lembaga</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="media" class="active">Ruang Media Guru</a></li>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Ruang Media Guru</h2>
          <ol>
            <li><a href="/">Home</a></li>
            <li>Ruang Media Guru</li>
          </ol>
        </div>
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          @foreach ($guru as $media )
            <article class="entry">

              <div class="entry-img">
                <img src="image/{{$media->image}}" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="">{{ $media->user->name }}</a></li>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="post-item clearfix">
                  <img src="assets/img/Istigosah/istigosahh.jpg" alt="">
                  <h4><a href="istigosah">Istigosah di Jagad 'Alimussiry Mojokerto</a></h4>
                  
                </div>
                <div class="post-item clearfix">
                  <img src="assets/img/Bimbel/media.jpg" alt="">
                  <h4><a href="bimbel">Bimbingan Nur Aini</a></h4>
                ...
                <div class="post-item clearfix">
                  <img src="assets/img/Koperasi/koperasi1.jpg" alt="">
                  <h4><a href="koperasi">Koperasi</a></h4>
                 
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/blog/blog-recent-4.jpg" alt="">
                  <h4><a href="konsultasi">Jagad Konsultasi</a></h4>
                 
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/media/kurikulum.jpg" alt="">
                  <h4><a href="media">Ruang Media Guru</a></h4>
                 
                </div>
                <div class="post-item clearfix">
                  <img src="assets/img/media/kurikulum.jpg" alt="">
                  <h4><a href="science">Science Club</a></h4>
