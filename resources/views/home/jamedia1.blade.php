...
<head>
  ...
  <title>JA MEDIA - Raj Hikmatul Karomah</title>
    ...
    <h1 class="logo me-auto"><img src="assets/img/logo.png" alt=""><a href=""> Raj <span> Hikmatul</span> Karomah</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="jamedia" class="active">JA MEDIA</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <iframe width="660" height="340" src="https://www.youtube.com/embed/9NrJnk0Ogvo" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>


              <h2 class="entry-title">
                <a href="#">Study Wisata Jagad 'Alimussiry Mojokerto</a>
              </h2>
            ...
            @foreach ($jamedia as $jamedia1 )
            <article class="entry">

              <div class="entry-img">
              <img src="image/{{$jamedia1->image}}" class="img-fluid" alt="">
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  ...
                  <li><a href="bimbel">Bimbel NurAni<span></span></a></li>
