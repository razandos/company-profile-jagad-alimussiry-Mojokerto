...
<head>
  ...
  <title>BIMBEL NUR AINI - Raj Hikmatul Karomah</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Unit Lembaga</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="bimbel" class="active">Bimbel Nurani</a></li>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Bimbingan Belajar Nur Aini </h2>
          <ol>
            <li><a href="/">Home</a></li>
            <li>Bimbingan Belajar Nur Aini</li>
          </ol>
        </div>
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          @foreach ($bimbel as $bimbel1 )
            <article class="entry">

              <div class="entry-img">
                <img src="image/{{$bimbel1->image}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="blog-single.html">{{$bimbel1->title}}</a>
              </h2>

              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="">{{ $bimbel1->user->name }}</a></li>
