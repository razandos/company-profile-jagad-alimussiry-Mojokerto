...
<head>
  ...
  <title>SCIENCE CLUB - Raj Hikmatul Karomah</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Unit Lembaga</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="science" class="active">Science Club</a></li>
          ...
          @foreach ($science as $science )
            <article class="entry">
              ...
              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="">{{ $science->user->name }}</a></li>
