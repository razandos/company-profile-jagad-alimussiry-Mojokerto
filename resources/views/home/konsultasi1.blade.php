...
<head>
  ...
  <title>KONSULTASI - Raj Hikmatul Karomah</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Unit Lembaga</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="konsultasi" class="active">Jagad Konsultasi</a></li>
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          @foreach ($konsultasi as $konsultasi1 )
            <article class="entry">

              <div class="entry-img">
                <img src="image/{{$konsultasi1->image}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="">{{$konsultasi1->title}}</a>
              </h2>

              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="">{{ $konsultasi1->user->name }}</a></li>
                </ul>
              </div>
              <!-- konsu$konsultasi1 adalah acara spiritual yang diadakan secara massal dengan tujuan untuk memperkuat ikatan batin dengan Allah SWT dan meningkatkan kedamaian spiritual. Acara ini dihadiri oleh jamaah yang berasal dari berbagai daerah, yang berkumpul dalam kebersamaan untuk beribadah, berdoa, dan mengungkapkan rasa syukur kepada Sang Pencipta.
              -->
              <div class="entry-content">
              <p id="content">
              {{$konsultasi1->description}}
             </p>
             
              <p id="additional-content" style="display: none;">
              {{$konsultasi1->description}}
              <br>
              {{$konsultasi1->descriptionlengkap}}
               </p>
